...
def main():
    ...
    st.markdown("""Get personalized SHL assessment recommendations based on your hiring needs.
    ...
    if input_method == "Natural Language Query":
        ...
        if url:
            st.warning("URL parsing not yet implemented. Please use text input for now.")
                    ...
                    for i, rec in enumerate(recommendations, 1):
                        with st.container():
                            ...
                            with col2:
                                ...
                                st.markdown(f" [{rec['assessment_url']}]({rec['assessment_url']})")
    ...
    with st.sidebar:
        st.header("ℹ About")
        st.markdown("""This system uses **semantic search** and **AI-powered balancing** to recommend 
