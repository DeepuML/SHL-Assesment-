...
class QuickOptimizer(HyperparameterOptimizer):
    ...
    def create_param_grid(self):
        ...
        print(f"Quick mode: Testing {len(param_combinations)} combinations (vs 324 in full mode)")
...
def main():
    ...
    if results['improvement'] > 2:
        print("  Significant improvement found! Run full optimization for even better results.")
