...
class EmbeddingEngine:
    ...
    def generate_embeddings(self, assessments: List[Dict], batch_size: int = 32) -> np.ndarray:
    ...
    def load_index(self):
        ...
        logger.info(f"Loaded index with {self.index.ntotal} vectors and {len(self.assessments)} assessments")
